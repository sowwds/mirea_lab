# Отчёт по заданию задание (микросервисная структура по управлению задачами) – ООО «СистемаКонтроля» по работе с строительными объектами
...
![Результат повторной регистрации](assets/test_screenshots/2_register_conflict.png)
